...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9621&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/socketio-client-nexus-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `socketio-client-nexus` can be installed with:

```
conda install socketio-client-nexus
```

It is possible to list all of the versions of `socketio-client-nexus` available on your platform with:
